...
Thanks to the open source [TwicPics](https://www.twicpics.com/?utm_source=github&utm_medium=organic&utm_campaign=components) Components, delivering responsive images in your [Nuxt 2](https://nuxtjs.org/) projects has never been easier.
...
All you have to do is set your configuration options to the desired values ([see documentation](https://www.twicpics.com/docs/components/nuxt-2?utm_source=github&utm_medium=organic&utm_campaign=components#setup-options)).
