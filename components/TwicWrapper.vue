...
<script>
const GITHUB_REPO_NAME = `TwicPics/components-demo-nuxt2`
...
export default {
  ...
  data() {
    return {
      onlineUrl: ``,
      documentationUrl: `https://www.twicpics.com/docs/components/nuxt-2?utm_source=github&utm_medium=organic&utm_campaign=components`,
